...
export class HUDGameComponent extends Container {
    ...
    private createTextFields(): void {
        /* Static Texts */
        let scoreLabel = PixiFactory.getText(Texts.SCORE, MagicValues.SIZE_HUD);
        ...
        this._movesLabel.pivot.x = this._movesLabel.width * .5;
        ...
        this._timeLabel.pivot.x = this._timeLabel.width * .5;
        ...
        this._movesText.pivot.x = this._movesText.width * .5;
